...
SUPABASE_URL = "https://teyceebtjinstsgvmyye.supabase.co"
# Get service role key from environment variable for security
SUPABASE_SERVICE_KEY = os.getenv('SUPABASE_SERVICE_KEY', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRleWNlZWJ0amluc3RzZ3ZteXllIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NjU0MzQxMSwiZXhwIjoyMDcyMTE5NDExfQ.YOUR_ACTUAL_SERVICE_KEY')
...
if __name__ == '__main__':
    ...
    print("\nSetup instructions:")
    print("1. Set SUPABASE_SERVICE_KEY environment variable")
