...
-- Insert originality_detector role for the originality user
-- Note: This assumes the user ID - you'll need to get the actual user_id from auth.users
INSERT INTO public.user_roles (user_id, role)
SELECT id, 'originality_detector'::app_role 
FROM auth.users 
WHERE email = 'originality@gmail.com';